        ...
        >
            <div className={`fixed inset-0 z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${isFiltersOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <div className="absolute left-0 top-0 h-full w-4/5 max-w-sm bg-white z-50 shadow-lg overflow-y-auto">
                    ...
                    <div className="p-4">
                        <CategoryFilters slug={slug ?? ""} selectedFilters={selectedFilters} onChange={handleFiltersChange} />
                    </div>
                </div>
            </div>
                ...
                <section className="flex-1">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
                        <div>
                            ...
                            <h1 className="text-2xl font-bold mt-1 text-black">{nameCategory}</h1>
                        </div>
                        ...
                        <div className="flex items-center gap-3 text-black">
                            ...
                            <button className="sm:hidden flex items-center gap-2 px-3 py-2 border rounded" onClick={() => setIsFiltersOpen(true)}>
                                Filtrar
                            </button>
                        </div>
                    </div>
